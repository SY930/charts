...
import { getChart2Data } from '../../api/home'
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Charts askData={this.state.askData} bidData={this.state.bidData} textX="basePrice" textY="与comp 的数量差 " />
      </React.Fragment >
